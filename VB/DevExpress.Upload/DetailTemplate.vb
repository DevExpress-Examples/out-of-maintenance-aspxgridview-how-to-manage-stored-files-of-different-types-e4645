...
Namespace DevExpress.Upload
    Public Class DetailTemplate
        ...
        Public Sub InstantiateIn(ByVal container As Control) Implements ITemplate.InstantiateIn
            ...
            If fileType = DevExpress.Upload.FileType.Html OrElse fileType = DevExpress.Upload.FileType.Text Then
        ...
        Private Function GetDetailControl(ByVal name As String, ByVal fileType As FileType) As Control
            Select Case fileType
                Case DevExpress.Upload.FileType.Image
                    Return GetBinaryImage(name)
                Case DevExpress.Upload.FileType.Html
                    Return GetHtmlEditor(name)
                Case DevExpress.Upload.FileType.Text
                    Return GetMemo(name)
                Case Else
                    Return Nothing
            End Select
